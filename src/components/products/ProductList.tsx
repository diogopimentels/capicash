                        ...
                        <CardContent className="p-4 flex items-center gap-4">
                            ...
                            <div className="flex flex-col items-end gap-1">
                                <div className={cn(
                                    ...
                                    product.sales > 0 ? "bg-emerald-500/10 text-emerald-500" : "bg-muted text-muted-foreground"
                                )}>
                    ...
                    {products.map((product) => (
                        <TableRow key={product.id}>
                            ...
                            <TableCell className="text-right">
                                <Button variant="ghost" size="icon" onClick={() => navigator.clipboard.writeText(product.link)}>
